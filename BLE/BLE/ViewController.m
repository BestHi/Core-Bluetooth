...
//  BLE
//
//  Created by healthplus-mt on 2017/4/26.
//  Copyright © 2017年 healthplus-mt. All rights reserved.
//
...
- (void)centralManagerDidUpdateState:(CBCentralManager *)central{
    ...
    switch (central.state) {
        ...
        case CBCentralManagerStatePoweredOn:
        {
            ...
            //搜索成功后，会调用我们找到外设的代理方法 sercices为空则会扫描所有的设备
...
/**
 发现外设服务调用的方法，下面的方法中凡是有error的在实际开发中，都要进行判断
 */
...
- (void)peripheral:(CBPeripheral *)peripheral didWriteData:(NSData *)data forCharacteristic:(nonnull CBCharacteristic *)characteristic{
    ...
    if (characteristic.properties & CBCharacteristicPropertyWrite) {
        ...
        [peripheral writeValue:data //写入的数据
             forCharacteristic:characteristic // 写个哪个特征
...
{
    // 外设为特征订阅通知数据会进入 peripheral:didUpdateValueForCharacteristic:error:方法
